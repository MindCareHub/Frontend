 ...
 const organizations = [
  {
    ...
    name: "I'm The Code",
    description:
      "Organisation béninoise engagée dans  le développement personnel et l’accompagnement des jeunes particulèierement des jeunes filles .",
  ...
  },
  {
    ...
    name: "BetterHelp",
    description:
      "la plus grande plateforme de thérapie en ligne au monde, dédiée à rendre les soins de santé mentale plus accessibles, abordables et pratiques",
  ...
  },
   {
    ...
    name: "Dis moi Care",
    description:
      "Service d'écoute en ligne -Application Mobile.",
    services: ["Ligne d'écoute", "Conseils psychosociaux", "Orientation familiale"],
    contact: "dimoi health.com"
  }
];
